...
export default function GameBoyShell({
  ...
  // ── PORTRAIT: full-bleed LCD top 50%, flat grey deck below — controls printed
  // straight on the shell body, no bottom bar: D-pad + A/B up top, SOCIALS +
  // INVENTORY centred below them, mute / ? in the bottom corners.
